...
var (
    ...
    Params = map[string][]string{ 
        ...
        "subscribeobjects.clear": { "Clear any previously subscribed objects from subscription list."  },  
        "subscribeobjects.ids": { "List of object ID's to subscribe to."  },  
        ...
        "unsubscribeobjects.clear": { "Clear any previously subscribed objects from subscription list."  },  
        "unsubscribeobjects.ids": { "List of object ID's to unsubscribe from."  },  

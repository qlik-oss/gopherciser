...
var (
    ...
    Params = map[string][]string{ 
        ...
        "config.scheduler.reconnectsettings": { "Settings to enable re-connection attempts on unexpected disconnects."  },  
        ...
        "reconnectsettings.backoff": { "Reconnect backoff scheme, defaults to [0.0, 1.0, 10.0, 20.0] if left empty"  },  
        "reconnectsettings.reconnect": { "Enable reconnect attempt when websocket gets disconnected, defaults to false."  },  

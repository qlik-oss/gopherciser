...
var (
    ...
    Params = map[string][]string{ 
        ...
        "containertab.activeid": { "ID of the object to set as active, used with mode `id`."  },  
        "containertab.id": { "ID of the container object."  },  
        "containertab.index": { "Zero based index of tab to switch to, used with mode `index`."  },  
        "containertab.mode": { "Mode for container tab switching, one of: `id`, `random` or `index`.","`id`: Switch to tab with object defined by `activeid`.","`random`: Switch to a random tab within the container.","`index`: Switch to tab with zero based index defined but `index`."  },  
